    ...
    return (
        ...
        >
            <defs>
                ...
                {/* Маска, которая будет анимировать высоту */}
                <mask id="mask" x="0" y="0" width="1009" height="263" maskUnits="userSpaceOnUse">
                    <rect
                        id="mask2"
                        ref={maskRef}
                        x="0"
                        y="0"
                        width="1009"
                        height="0" // старт высоты 0
                        fill="white"
                    />
                </mask>
            </defs>

            {/* Путь с градиентом и примененной маской */}
            <path
                ...
                fill="url(#paint0_radial_336_500)"
                mask="url(#mask)"
            />
        </svg>
    );
