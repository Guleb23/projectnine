...
const ThreeFone = ({ children, id }) => {
    ...
    return (
        ...
        >
            <img
                className="absolute inset-0 min-h-screen h-full m-auto select-none pointer-events-none rounded-4xl"
                src="/Second/whiteblur.png"
                alt="White Blur"
            />
            <div className="grid 2xl:mx-[3%] grid-rows-4 gap-[50px] sm:gap-6 md:grid-cols-2 md:grid-rows-2 w-screen mb-[14%] min-h-screen h-full  md:h-[130vh] px-[20px] ">
                {children}
            </div>
            <ThreeBigCard />
