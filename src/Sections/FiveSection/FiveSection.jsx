...
const FiveSection = () => {
    return (
        <FiveFone id={`five`} >
            ...
            <h3 className='flex justify-center items-center font-bold text-[23px] gradient-text-green text-center pt-[5%]'>
                Boosting client AI chips energy<br /> efficiency (TOPS/W)
            </h3>
            <h3 className='flex justify-center items-center font-medium mono text-[13px] gradient-text-green text-center pt-[1%]'>
