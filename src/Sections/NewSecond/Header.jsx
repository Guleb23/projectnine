    ...
    return (
        ...
        >
            <p
                ...
                className={`${four ? "w-[500px]" : ""} bg-[radial-gradient(91.74%_158.57%_at_50%_50%,_#00DA90_0%,_rgba(225,255,222,0.25)_100%)] bg-clip-text text-transparent w-full mono lg:text-[13px] sm:text-[19px] text-[10px] font-normal`}
