...
const ThreeScetion = () => {
    ...
    return (
        <ThreeFone id="three">
            <ThreeCard ref={addToRefs} img={`/Three/one.png`} mainText={`Physics’ Deadline`} customStyles={`justify-self-center md:ml-[51%] 2xl:ml-[44%]`} subText={`GPUs hit limits — 3nm chips improve efficiency by just 15%`} />
